...
fun Strings.zhHKlegacy(): String? = when (this) {
    ...
    MenuFileOpen -> "開啟檔案..."
    MenuFileOpenRecent -> "開啟最近使用歷史"
    MenuFileOpenRecentClear -> "清除最近使用歷史"
    MenuFileQuickEdit -> "快速編輯"
    MenuFileSave -> "儲存"
    MenuFileSaveAs -> "另存新檔..."
    MenuFileProjectSetting -> "項目設定..."
    MenuFileImportProject -> "匯入項目..."
    MenuFileReloadLabelFile -> "重新加載標籤檔案"
    MenuFileReloadLabelFilePickFile -> "使用所選的檔案..."
    MenuFileReloadLabelFileDefault -> "使用輸出的檔案..."
    MenuFileReloadLabelFileDefaultWithoutConfirmation -> "使用輸出的檔案（跳过确认）"
    MenuFileExport -> "匯出為標籤檔案..."
    MenuFileExportOverwrite -> "覆寫匯出標籤檔案"
    MenuFileExportOverwriteAll -> "覆寫匯出標籤檔案"
    MenuFileInvalidateCaches -> "清除快取"
    MenuFileClose -> "關閉"
    MenuEdit -> "編輯"
    MenuEditUndo -> "撤銷"
    MenuEditRedo -> "重做"
    MenuEditTools -> "工具"
    MenuEditToolsCursor -> "鼠標"
    MenuEditToolsScissors -> "剪刀"
    MenuEditToolsPan -> "移動"
    MenuEditToolsPlayback -> "播放"
    MenuEditRenameEntry -> "更改目前條目名稱..."
    MenuEditDuplicateEntry -> "製作目前條目的副本..."
    MenuEditRemoveEntry -> "刪除目前條目..."
    MenuEditMoveEntry -> "移動當前條目至..."
    MenuEditToggleDone -> "切換當前條目完成狀態"
    MenuEditToggleStar -> "切換當前條目星標狀態"
    MenuEditEditTag -> "編輯目前條目..."
    MenuEditEditEntryExtra -> "編輯目前條目之附加資料..."
    MenuEditMultipleEditMode -> "編輯所有關聯條目"
    MenuEditEditModuleExtra -> "編輯目前子項目之附加資料..."
    MenuView -> "檢視"
    MenuViewToggleMarker -> "顯示參數"
    MenuViewPinEntryList -> "固定條目列表"
    MenuViewPinEntryListLocked -> "鎖定條目條"
    MenuViewToggleProperties -> "顯示屬性"
    MenuViewToggleToolbox -> "顯示工具欄"
    MenuViewToggleTimescaleBar -> "顯示時間刻度"
    MenuViewOpenSampleList -> "開啟音檔清單"
    MenuViewVideo -> "開啟相關影片"
    MenuViewVideoOff -> "關閉"
    MenuViewVideoEmbedded -> "內陷式"
    MenuViewVideoNewWindow -> "在新視窗"
    MenuNavigate -> "導覽"
    MenuNavigateOpenLocation -> "開啟目錄"
    MenuNavigateOpenLocationRootDirectory -> "開啟項目之根目錄"
    MenuNavigateOpenLocationModuleDirectory -> "目前子項目的音檔目錄"
    MenuNavigateOpenLocationProjectLocation -> "項目文件所在目錄"
    MenuNavigateNextEntry -> "下一項條目"
    MenuNavigatePreviousEntry -> "上一項條目"
    MenuNavigateNextSample -> "下一個音檔"
    MenuNavigatePreviousSample -> "上一個音檔"
    MenuNavigateJumpToEntry -> "跳轉到條目..."
    MenuNavigateNextModule -> "下一個子項目"
    MenuNavigatePreviousModule -> "上一個子項目"
    MenuNavigateJumpToModule -> "跳轉到子項目..."
    MenuNavigateScrollFit -> "滾動至顯示當前條目"
    MenuTools -> "工具"
    MenuToolsBatchEdit -> "批量编辑"
    MenuToolsBatchEditQuickLaunchManager -> "槽位设置"
    MenuToolsBatchEditQuickLaunch -> "槽位 %d：%s"
    MenuToolsBatchEditShowDisabledItems -> "顯示目前項目下不可使用的插件"
    MenuToolsBatchEditManagePlugins -> "管理插件..."
    MenuToolsPrerender -> "預先渲染所有圖表..."
    MenuToolsSyncSample -> "轉換所有相對於採樣文件尾的數值..."
    MenuToolsRecycleMemory -> "回收記憶體/RAM"
    MenuToolsFileNameNormalizer -> "規範化檔案名..."
    MenuSettings -> "設定"
    MenuSettingsPreferences -> "偏好設定..."
    MenuSettingsLabelers -> "標籤編輯器..."
    MenuSettingsTemplatePlugins -> "標籤模板生成器..."
    MenuSettingsTracking -> "使用數據收集..."
    MenuHelp -> "幫助"
    MenuHelpCheckForUpdates -> "檢查更新..."
    MenuHelpOpenLogDirectory -> "開啟日誌目錄"
    MenuHelpIncludeInfoLog -> "使用詳細日誌記錄模式"
    MenuHelpOpenHomePage -> "打开 vLabeler 主頁"
    MenuHelpOpenLatestRelease -> "打开最新版本之發布頁面"
    MenuHelpOpenGitHub -> "打开 GitHub 頁面"
    MenuHelpJoinDiscord -> "加入 Discord"
    MenuHelpAbout -> "關於 vLabeler"
    CommonOkay -> "確定"
    CommonApply -> "確定/儲存/使用"
    CommonCancel -> "取消"
    CommonYes -> "是"
    CommonNo -> "否"
    CommonWarning -> "警告"
    ...
    CommonReset -> "重置"
    CommonClear -> "清空"
    CommonInputErrorPromptNumber -> "請輸入一個數字。"
    CommonInputErrorPromptInteger -> "請輸入一個整數。"
    CommonInputErrorPromptNumberRange -> "請輸入
入一個介乎於 %s 和 %s 之間的數字。"
    CommonInputErrorPromptNumberMin -> "請輸入一個不小於 %s 的數字。"
    CommonInputErrorPromptNumberMax -> "請輸入一個不大於 %s 的數字。"
    CommonRootModuleName -> "（根）"
    StarterStart -> "開始"
    StarterNewProject -> "新建项目..."
    StarterOpen -> "開啟..."
    StarterQuickEdit -> "快速編輯"
    StarterRecent -> "最近使用"
    StarterRecentEmpty -> "最近的項目使用歷史會顯示於這裡。"
    StarterRecentDeleted -> "該項目已被刪除。。"
    StarterNewSampleDirectory -> "音檔目录"
    StarterNewWorkingDirectory -> "項目檔案存放位置"
    StarterNewProjectTitle -> "新建項目"
    StarterNewProjectName -> "項目名"
    StarterNewProjectNameWarning -> "該項目檔案已存在，繼續創建將複寫原始檔案。"
    StarterNewCacheDirectory -> "快取目錄"
    StarterNewLabelerCategory -> "類別"
    StarterNewLabeler -> "標籤編輯器"
    StarterNewTemplatePlugin -> "模板生成器"
    StarterNewTemplatePluginNone -> "尚無"
    StarterNewInputFile -> "匯入文件 (.%s)"
    StarterNewEncoding -> "編碼"
    StarterNewAutoExport -> "自動匯出"
    StarterNewAutoExportHelp -> "儲存時，自動將項目覆寫並匯出到匯入檔案（如未指定匯入檔案，將自動匯出至標籤編輯器指定位置）。"
    StarterNewWarningSelfConstructedLabelerWithTemplatePlugin ->
        "您正在嘗試在一個管理多個子項目的標籤編輯器上使用模板生成器。" +
            "這是極度危險的。這有可能會導致所有目前的標籤檔案被覆寫或刪除。請再次確認你的設置是否正確，以確保檔案安全。"
    StarterNewDirectoryPage -> "目錄設定"
    StarterNewLabelerPage -> "標籤編輯器設定"
    StarterNewDataSourcePage -> "數據源設定"
    StarterNewContentType -> "創建自..."
    StarterNewContentTypeDefault -> "預設"
    StarterNewContentTypeFile -> "檔案"
    StarterNewContentTypePlugin -> "模板生成器"
    StarterNewAdvancedSettings -> "進階設定"
    SampleListIncludedHeader -> "項目所使用之音檔"
    SampleListIncludedItemEntryCountSingle -> "%d 條目"
    SampleListIncludedItemEntryCountPlural -> "%d 條目"
    SampleListExcludedHeader -> "項目中未使用到的音檔"
    SampleListExcludedPlaceholder -> "目前使用中的目錄所有音檔都已被使用。"
    SampleListEntryHeader -> "條目"
    SampleListEntriesPlaceholderUnselected -> "在左邊選擇一個音檔以查看其關聯到的條目。"
    SampleListEntriesPlaceholderNoEntry -> "還音檔沒有任何條目。"
    SampleListEntriesPlaceholderNoEntryButton -> "以音檔建立預設條目"
    SampleListCreateDefaultForAllButton -> "以所有沒使用的音檔建立預設條目"
    SampleListJumpToSelectedEntryButton -> "跳轉至已選擇的條目"
    SampleListOpenSampleDirectoryButton -> "開啟音檔列表"
    SampleListCurrentModuleLabel -> "子項目："
    SampleListSampleDirectoryLabel -> "音檔列表："
    SampleListSampleDirectoryRedirectButton -> "切換音檔目錄"
    PrerendererModuleText -> "渲染子項目 %d/%d..."
    PrerendererModuleTextFinished -> "渲染子項目 %d/%d... 完成"
    PrerendererSampleText -> "渲染音檔 %d/%d..."
    PrerendererSampleTextFinished -> "渲染音檔 %d/%d... 完成"
    PrerendererChartText -> "渲染圖表 %d/%d..."
    PrerendererChartTextFinished -> "渲染圖表 %d/%d... 完成"
    EditorRenderStatusLabel -> "%d/%d 渲染中..."
    ChooseSampleDirectoryDialogTitle -> "选择選擇音檔目錄"
    ...
    PreferencesChartsFundamentalSemitoneResolution -> "图像中每个半音的分辨率"
    PreferencesChartsFundamentalMinFundamental -> "最小频率（Hz）"
    PreferencesChartsFundamentalMinFundamentalInvalid -> "最小频率必须小于最大频率。"
    PreferencesChartsFundamentalMaxFundamental -> "最大频率（Hz）"
    PreferencesChartsFundamentalMaxFundamentalInvalid -> "最大频率必须大于最小频率。"
    PreferencesChartsFundamentalSemitoneSampleNum -> "每个半音的采样数"
    PreferencesChartsFundamentalMaxHarmonicFrequency -> "最大谐波频率（Hz）"
    PreferencesChartsFundamentalMaxHarmonicFrequencyInvalid -> "最大谐波频率必须大于最大频率。"
    PreferencesChartsFundamentalDrawReferenceLine -> "绘制C音阶参考线"
    PreferencesChartsFundamentalColor -> "前景色"
    PreferencesChartsFundamentalReferenceLineColor -> "参考线颜色"
    PreferencesChartsFundamentalBackgroundColor -> "背景色"
    ...
    PreferencesEditorScissorsScissorsSubmitThreshold -> "提交阈值（DP）"
    PreferencesEditorScissorsScissorsSubmitThresholdDescription ->
        "在使用剪刀工具点击后，当您移动鼠标的距离超过该数值时，切割操作将会被提交。"
    ...
    ImportEntriesDialogReplaceContent -> "删除现有条目"
    ImportEntriesDialogReplaceContentDisabledDescription -> "当前项目不支持追加条目，因此导入时，现有的条目将全部被删除。"
